...
public class AccountAggregateTest {
    ...
    public void testCloseAccount_Success() {
        fixture.given(new AccountOpenedEvent("A123", "Rahul", 0.0))
                .when(new CloseAccountCommand("A123", "Customer Request"))
                .expectSuccessfulHandlerExecution()
                .expectEvents(new AccountClosedEvent("A123", "Customer Request"));
    }
    ...
    public void testCloseAccount_AlreadyClosed() {
        fixture.given(new AccountOpenedEvent("A123", "Rahul", 0.0),
                        new AccountClosedEvent("A123", "Customer Request"))
                .when(new CloseAccountCommand("A123", "Duplicate Close"))
                .expectException(IllegalStateException.class);
    }
}
