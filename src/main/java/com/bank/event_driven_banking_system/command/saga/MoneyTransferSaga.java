...
@Saga                                   //This class is an Axon Saga.
                                        // Its job is to coordinate a long-running business transaction
public class MoneyTransferSaga
{
    private transient CommandGateway commandGateway;        // CommandGateway -saga sends commands to aggregate
    ...
    public MoneyTransferSaga(CommandGateway commandGateway, EventGateway eventGateway)
    {
